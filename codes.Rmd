...
name_changes <- c("100940" = "Bread", "100950" = "SlicedBread", "101020" = "Baguette", "101090" = "Bap",
                  ...
                  "102170" = "Soya", "102180" = "Fruitcake", "102190" = "Cake", "102200" = "Doughnut", "102210" = "Spongepuddin", "102220" = "Cheesecake", "102230" = "Othdessert", "102250" = "SweetsnackConsum", "102260" = "Chocolatebar", "102270" = "WhiteChocolate", "102280" = "MilkChocolate", "102290" = "DarkChocolate", "102300" = "ChocolateRaisin", "102310" = "Chocolatesweet", "102320" = "Dietsweet", "102330" = "Sweets", "102340" = "ChocolateCoverBiscuit", "102350" = "ChocolateBiscuit", "102360" = "SweetBiscuit", "102370" = "CerealBar", "102380" = "OthSweet", "102400" = "Savoury", "102410" = "SaltPeanut", "102420" = "Peanut", "102430" = "SaltNut", "102440" = "Nut", "102450" = "Seeds", "102460" = "Crisp", "102470" = "SavouryBiscuit", "102480" = "CheesyBiscuit", "102490" = "Olives", "102500" = "OthSavoury", "102520" = "SoupConsum", "102530" = "InstantSoup", "102540" = "CannnedSoup", "102620" = "HomeSoup", "102700" = "StarchyConsum", "102710" = "WhitePasta", "102720" = "WholemealPasta", "102730" = "WhiteRice", "102740" = "BrownRice", "102750" = "Sushi", "102760" = "Snackpot", "102770" = "Couscous", "102780" = "OthGrain")
...
rm(datab)
rm(dataa)
dataa <- read.csv(file = 'C:/Users/timothy/Documents/GWAS_data/dairy/data11_liquids.csv')
datab <- merge(dataa,datac,by="EID")
write.csv(datab, "C:\\Users\\timothy\\Documents\\GWAS_data\\dairy\\food_liquids.csv",na='',row.names=FALSE)
rm(datab)
rm(dataa)
dataa<- read.csv(file = 'C:/Users/timothy/Documents/GWAS_data/dairy/data12_grain_dessert.csv')
datab <- merge(dataa,datac,by="EID")
write.csv(datab, "C:\\Users\\timothy\\Documents\\GWAS_data\\dairy\\food_grain_dessert.csv",na='',row.names=FALSE)
rm(datab)
rm(dataa)
dataa<- read.csv(file = 'C:/Users/timothy/Documents/GWAS_data/dairy/data13_meat_vege.csv')
datab <- merge(dataa,datac,by="EID")
write.csv(datab, "C:\\Users\\timothy\\Documents\\GWAS_data\\dairy\\food_meat_vege.csv",na='',row.names=FALSE)
rm(list=ls())
```


```{r}
#get all data available (more efficient and maintainable than the above one)
# Define function for the repeated steps
merge_and_write <- function(input_filename, output_filename, datac) {
  data <- read.csv(file = paste0('C:/Users/timothy/Documents/GWAS_data/dairy/', input_filename))
  merged_data <- merge(data, datac, by = "EID")
  write.csv(merged_data, paste0('C:/Users/timothy/Documents/GWAS_data/dairy/', output_filename), na = '', row.names = FALSE)
}
...
files <- list(
  list(input = "data10_continuous.csv", output = "food_contious.csv"),
  list(input = "data11_liquids.csv", output = "food_liquids.csv"),
  list(input = "data12_grain_dessert.csv", output = "food_grain_dessert.csv"),
  list(input = "data13_meat_vege.csv", output = "food_meat_vege.csv")
)

# Use a for loop to process all files
for (file in files) {
  merge_and_write(file$input, file$output, datac)
}
