...
name_changes <- c("102930" = "EggConsum", "102940" = "WholeEgg", "102950" = "Omelette", "102960" = "EgginSandwich",
                  ...
                  "103270" = "Tofu", "103280" = "Quorn", "103290" = "OthVege", "103310" = "SpreadConsum", 
...
datab<-merge(df,datac,by="EID")
rm(df)
# Check each value in each column and if it is not numeric, replace it with NA
datab[] <- lapply(datab, function(x) ifelse(is.numeric(x), x, NA))
# Then you can remove rows with NA values
datab <- na.omit(datab)
